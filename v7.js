...
setInterval(()=>{const on=Boolean(state.voiceJoinedChannelId);mobileCallPill.classList.toggle('hidden',!on);if(on){mobileCallPill.querySelector('strong').textContent=state.voiceJoinedChannelName||'Call ativa';}},700);
