...
function updatePrefsSidebarSummary() {
  ...
  if (status) status.textContent = '@' + (state.profile?.username || displayName).toLowerCase();
...
async function boot() {
  ...
  if ("serviceWorker" in navigator && location.protocol === "https:") navigator.serviceWorker.register("./sw.js?v=7.4.0").catch(() => {});
