...
document.addEventListener("keydown", (event) => { if (event.key === "Escape" && ui.mediaStage?.classList.contains("focus-mode")) clearFocusedMediaCard(); });
...
async function boot() {
  ...
  if ("serviceWorker" in navigator && location.protocol === "https:") navigator.serviceWorker.register("./sw.js?v=7.3.9").catch(() => {});
