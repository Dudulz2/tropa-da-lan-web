...
## V6.1 — Qualidade de voz
- áudio de voz otimizado;
- Opus priorizado;
- seletor rápido de microfone durante a chamada;
- troca de microfone sem sair da call;
- fallback automático para dispositivo padrão;
- teste de microfone melhorado.
